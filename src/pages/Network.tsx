...
import { Network as NetworkIcon, HardHat } from 'lucide-react';
...
export const Network: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[75vh] text-center space-y-6">
      ...
      <div>
        <h1 className="text-2xl font-black text-slate-800 tracking-tight mb-2">Topología de Red</h1>
        <p className="text-slate-500 font-medium max-w-md mx-auto">
          La visualización interactiva de la red y la inspección de nodos (Amazon VPC) se encuentra actualmente en fase de producción para la próxima versión release.
        </p>
      </div>
